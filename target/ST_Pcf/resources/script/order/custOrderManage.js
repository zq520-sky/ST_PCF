...
function cancel(id, orderCode) {
    if (Number(id)) {
        ...
        layer.confirm(msg, {
            ...
            $.get(ctx.path + "/manage/cust/order/1/cancel"+ ctx.bizSuffix + "?orderId=" + id + "&orderCode=" + orderCode, function(result) {
                if (result.rs == 1) {
...
function del(id, orderCode) {
    if (Number(id)) {
        ...
        layer.confirm(msg, {
            ...
            $.get(ctx.path + "/manage/cust/order/1/del"+ ctx.bizSuffix + "?orderId=" + id + "&orderCode=" + orderCode, function(result) {
                if (result.rs == 1) {
