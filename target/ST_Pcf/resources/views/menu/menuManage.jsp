...
<%--						<label class="radio" id="addRadioLable2"><input type="radio" name="sysType" value="2"><em>代理商端</em></label>--%>
...
<%--						<label class="radio"><input type="radio" name="sysType" value="2"><em>代理商端</em></label>--%>
