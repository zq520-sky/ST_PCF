...
<html>
	<head>
		...
		<script src="${ctx.path}/resources/script/task/custTaskInfoManage.js?v=1.2"></script>
                ...
                $("#editId #buyerCodeEdit").autocomplete(
                    {
                        ...
                        select: function (event, ui) {
							$("#menu_"+ui.item.id).click(function(){
								$("#platformTypeEdit").val(ui.item.platformType);
							});
	...
	<body>
		...
		<div id="editId" class="detail_box mCustomScrollbar_y" data-mcs-theme="dark" style="display:none;">
			<form method="post" id="editForm" action="${ctx.path}/manage/task/editCustTaskInfo${ctx.bizSuffix}">
				...
				<input type="hidden" id="taskCodeEditHid" name="task.taskCode">
				<table width="100%">
					<thead>
					<tr>
						<th colspan="2">订单信息</th>
