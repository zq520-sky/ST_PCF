...
<body>
<div class="main_con">
    <form class="tableform" action="${ctx.path}/manage/finance/queryOrderInfoListByCustId${ctx.pageSuffix}" method="post" id="pageForm">
                    ...
                    <div class="tablelist_thead">
                        <table>
                            <tr>
                                ...
                                <th width="100">充值前账户余额(元)</th>
                                <th width="100">充值后账户余额(元)</th>
                        ...
                        <c:forEach items="${pageData.data }" var="data" varStatus="staus">
                            <tr>
                                ...
                                <td class="operation_td">
                                    <p:auth mcode="MENU_MANAGE_FINANCE_CUST_ORDER_INFO_VIEW">
