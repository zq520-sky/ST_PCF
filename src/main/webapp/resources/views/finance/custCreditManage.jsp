        ...
        <div class="operation_box" id="operation_box">
            <div class="operation_con">
                ...
                <div class="operation_info">
                    <p:auth mcode="MENU_MANAGE_FINANCE_CREDIT_EXPORT">
                        <button type="button" class="btn add_btn" onclick="fun_export('${ctx.path}/manage/finance/exportCreditInfoList${ctx.bizSuffix}')">
                    ...
                    <div class="tablelist_thead">
                        <table>
                            <tr>
                                ...
                                <th width="100">操作前授信余额(元)</th>
                                <th width="100">操作后授信余额(元)</th>
                                <th width="100">授信金额(元)</th>
                                <th width="100">授信时间</th>
                        ...
                        <c:forEach items="${pageData.data }" var="data" varStatus="staus">
                            <tr>
                                ...
                                <td class="operation_td">
                                    <p:auth mcode="MENU_MANAGE_FINANCE_CREDIT_INFO_VIEW">
                                        <button class="operationbtn" type="button" onclick="viewCreditPage(${data.creditId});">
                                            <span>查看</span>
                                        </button>
                                    </p:auth>
                                </td>
...
<div id="viewId" class="add_box mCustomScrollbar_y">
    <form method="post" id="viewForm">
        <div class="add_list">
            <h5 style="width: 138px">客户编号：</h5>
            <div class="add_value" style="margin-left: 147px;">
                <span id="custCode"></span>
            </div>
        </div>
        <div class="add_list">
            <h5 style="width: 138px">客户名称：</h5>
            <div class="add_value" style="margin-left: 147px;">
                <span id="custName"></span>
            </div>
        </div>
        <div class="add_list">
            <h5 style="width: 138px">所属公司：</h5>
            <div class="add_value" style="margin-left: 147px;">
                <span id="companyName"></span>
            </div>
        </div>
        <div class="add_list">
            <h5 style="width: 138px">美元汇率：</h5>
            <div class="add_value" style="margin-left: 147px;">
                <span id="dollarRate"></span>
            </div>
        </div>
        <div class="add_list">
            <h5 style="width: 138px">授信金额(元)：</h5>
            <div class="add_value" style="margin-left: 147px;">
                <span id="creditMoney"></span>
            </div>
        </div>
        <div class="add_list">
            <h5 style="width: 138px">操作前授信余额(元)：</h5>
            <div class="add_value" style="margin-left: 147px;">
                <span id="beforeCreditMoney"></span>
            </div>
        </div>
        <div class="add_list">
            <h5 style="width: 138px">操作后授信余额(元)：</h5>
            <div class="add_value" style="margin-left: 147px;">
                <span id="afterCreditMoney"></span>
            </div>
        </div>
        <div class="add_list">
            <h5 style="width: 138px">授信时间：</h5>
            <div class="add_value" style="margin-left: 147px;">
                <span id="creditTime"></span>
            </div>
        </div>
        <div class="add_list">
            <h5 style="width: 138px">备注：</h5>
            <div class="add_value" style="margin-left: 147px;">
                <span id="remark"></span>
            </div>
        </div>
