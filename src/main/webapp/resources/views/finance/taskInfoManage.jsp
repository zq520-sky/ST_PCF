...
<body>
<div class="main_con">
    <form class="tableform" action="${ctx.path}/manage/finance/queryTaskInfoList${ctx.pageSuffix}" method="post" id="pageForm">
        <div class="operation_box" id="operation_box">
            <div class="operation_con">
                <div class="currenttit"></div>
                <div class="operation_info">
                    <p:auth mcode="MENU_MANAGE_FINANCE_TASK_EXPORT">
                        <button type="button" class="btn add_btn" onclick="fun_export('${ctx.path}/manage/finance/exportTaskInfoList${ctx.bizSuffix}')">
                        ...
                        <c:forEach items="${pageData.data }" var="data" varStatus="staus">
                            <tr>
                                ...
                                <td class="operation_td">
                                    <p:auth mcode="MENU_MANAGE_TASK_INFO_VIEW">
                                        <button class="operationbtn" type="button" onclick="viewTaskPage(${data.taskId},${data.orderId});">
                                            <span>查看</span>
                                        </button>
                                    </p:auth>
                                </td>
