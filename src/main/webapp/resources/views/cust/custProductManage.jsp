...
<html>
	<head>
		...
		<script src="${ctx.path}/resources/script/cust/custProductManage.js?v=1.0"></script>
	...
	<body>
				...
				<div class="operation_box" id="operation_box">
					...
					<div class="search_box" id="search_box">
						<div class="search_nav">
							<ul>
								<li>
									<input type="text" id="searchaccountsName" name="accountsName" class="inputtext" placeholder="卖家账号（店铺名称）" value="${custProductVo.accountsName}"/>
								</li>
								<li>
		...
		<div id="editId" name="editName" class="add_box mCustomScrollbar_y" data-mcs-theme="dark" style="display:none;">
			<form method="post" id="editForm" action="${ctx.path}/manage/custProduct/editCustProduct${ctx.bizSuffix}">
				...
				<div class="add_list">
					<h5 style="width: 143px;"><em style="color: red;">*</em>电商平台：</h5>
					<div class="add_value" style="margin-left: 156px;">
				...
				<div class="add_list">
					<h5 style="width: 143px;"><em style="color: red;">*</em>卖家账号(店铺名称)：</h5>
					<div class="add_value" style="margin-left: 156px;">
