...
import com.samton.platform.pm.dao.*;
...
public class PmServiceImpl implements IPmService{
	 ...
	 */
	@Override
	public int setCustUser(Integer sysType, Integer custId, Integer state) throws Exception {
		return pmUserMapper.updateCustUser(sysType, custId, state);
	}
}
