...
public interface TCustTaskMapper extends AutoMapperInteger<TCustTask> {
     ...
     * @return
     **/
    TCustTask selectTaskByCode(String taskCode) throws Exception;
     ...
     * @throws Exception
     */
    String autoAllocateTask(String jsonStr) throws Exception;
     ...
     * @throws Exception
     */
    String updateTaskOk(String jsonStr) throws Exception;
}