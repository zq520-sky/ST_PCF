...
public class CustomerExpCodeConstant extends ExpCodeConstant {
	...
	public static final String CUST_ADD_COLUMN_ERROR = "11001";
	public static final String CUST_EDIT_COLUMN_ERROR = "11002";
	public static final String CUST_EDIT_ID_ERROR = "11003";
	public static final String CUST_EDIT_SET_ERROR = "11004";


	static {
		msgMap.put(CUST_ADD_COLUMN_ERROR, "新增失败，请重新输入！");
