            ...
            <div class="operation_con">
                ...
                <div class="operation_info">
                    <p:auth mcode="MENU_MANAGE_FINANCE_ORDER_EXPORT">
                        <button type="button" class="btn add_btn" onclick="fun_export('${ctx.path}/manage/finance/exportOrderInfoList${ctx.bizSuffix}')">
                        ...
                        <c:forEach items="${pageData.data }" var="data" varStatus="staus">
                            <tr>
                                ...
                                <td class="operation_td">
                                    <p:auth mcode="MENU_MANAGE_FINANCE_INFO_VIEW">
                                        <button class="operationbtn" type="button" onclick="viewOrderPage(${data.orderId});">
                                            <span>查看</span>
                                        </button>
                                    </p:auth>
                                </td>
