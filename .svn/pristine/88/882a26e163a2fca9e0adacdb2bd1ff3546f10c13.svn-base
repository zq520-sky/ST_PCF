...
<head>
    ...
    <script src="${ctx.path}/resources/script/order/custOrderManage.js?v=1.5"></script>
...
<div id="addCustOrder" class="detail_box mCustomScrollbar_y" data-mcs-theme="dark" style="display:none;">
    <form method="post" id="addCustOrderForm" action="${ctx.path}/manage/cust/order/1/addCustOrder${ctx.bizSuffix}">
        <table width="100%">
            <thead>
            <tr>
...
<%--                <th colspan="2">订单编号：<span id="orderCodeAdd"></span></th>--%>
            ...
            <tbody>
                <tr>
                    <th><em style="color: red;">*</em>客户名称：</th>
                    <td><st:commonSelect className="select" name="custId" defaultText="请选择" defaultValue="" onchange="customerChange(this.options[this.options.selectedIndex].value);"
                                         sql="select cust_id as val, cust_name as text from t_customer"/></td>
                    <th>客户编号：</th>
                    <td>
...
<div id="editCustOrder" class="detail_box mCustomScrollbar_y" data-mcs-theme="dark" style="display:none;">
    <form method="post" id="editCustOrderForm" action="${ctx.path}/manage/cust/order/1/updateCustOrder${ctx.bizSuffix}">
        <table width="100%">
            <thead>
            <tr>
            ...
            <tr>
                <th><em style="color: red;">*</em>客户名称：</th>
                <td><st:commonSelect className="select" id="custIdEdit" name="custId" defaultText="请选择" defaultValue="" onchange="customerChange(this.options[this.options.selectedIndex].value);"
                                         sql="select cust_id as val, cust_name as text from t_customer"/></td>
                <th>客户编号：</th>
                <td>
...
<div id="importCustOrder" class="add_box mCustomScrollbar_y" >
    <form method="post" enctype="multipart/form-data" id="importOrderForm" action="${ctx.path}/manage/cust/order/1/importOrders${ctx.bizSuffix}">
        <div>
        ...
        <div class="add_list">
            ...
            <div class="add_value">
                ...
                <a href="#" style="color:blue;" onclick="fun_export('${ctx.path}/manage/cust/order/1/downloadTemple${ctx.noAuthSuffix}')">模板下载</a>
            </div>
        </div>
        <div class="add_list">
