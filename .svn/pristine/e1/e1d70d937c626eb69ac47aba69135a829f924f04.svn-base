...
public interface ICustTaskService extends ISuperIntegerService<TCustTask> {
     ...
     * @throws Exception
     */
    String reportSettingOk(CustTaskInfoVo custTaskInfoVo) throws Exception;

    boolean editRefund(CustTaskInfoVo custTaskInfoVo) throws Exception;
    /**
     * @Author ZhongShengbin
     ...
     * @throws Exception
     */
    String autoAllocateTask(int type) throws Exception;
