...
<body>
<div class="main_con">
    <form class="tableform" action="${ctx.path}/manage/finance/queryReturnInfoListByCustId${ctx.pageSuffix}" method="post" id="pageForm">
        <div class="operation_box" id="operation_box">
            <div class="operation_con">
                <div class="currenttit"></div>
                <div class="operation_info">
                    <p:auth mcode="MENU_MANAGE_CUST_FINANCE_RETURN_EXPORT">
                        <button type="button" class="btn add_btn" onclick="fun_export('${ctx.path}/manage/finance/exportReturnInfoListByCustId${ctx.bizSuffix}')">
                        ...
                        <c:forEach items="${pageData.data }" var="data" varStatus="staus">
                            <tr>
                                ...
                                <td class="operation_td">
                                    <p:auth mcode="MENU_MANAGE_CUST_FINANCE_RETURN_VIEW">
                                        <button class="operationbtn" type="button" onclick="viewCustReturnPage(${data.returnId});">
                                            <span>查看</span>
                                        </button>
                                    </p:auth>
                                </td>
