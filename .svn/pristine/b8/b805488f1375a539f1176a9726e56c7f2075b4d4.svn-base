...
<%@ page language="java" import="com.samton.platform.framework.util.CurrentUtil"%>
...
<html>
	<head>
		...
		<script type="text/javascript" src="${ctx.path}/resources/script/main/main.js?v=1.4"></script>
	...
	<body onbeforeunload="body_onUnload()">
		...
		<div class="main_box">
			...
			<div class="company_name">
				<span class="company_info">南昌卡洛菲电子商务有限公司</span>
			</div>
			<div style="float: left;line-height: 49px; display: inline;font-size: 16px;font-weight:bold;margin-left:20px;color:#4b5163;">
				<div class="customerInfo"><span id="customer_name"></span>(<span id="customer_code"></span>)</div>
			</div>
			<div style="float: left;line-height: 49px; display: inline; font-size: 14px;font-weight:bold; margin-left:100px;color:#4b5163;">
				<span class="customerInfo" >账户余额：<em id="account_money"></em>元</span>
				<span class="customerInfo" >授信余额：<em id="credit_money"></em>元</span>
			</div>
			<div class="mininav">
				<dl>
					<dd class="relative" id="qqService" style="margin-top: 18px;font-size: 13px;font-weight:bold;">
						<span class="customerInfo">客服QQ：8888888888</span>
					</dd>
